...
function __createBinding2(o5, m2, k2, k22) {
  if (k22 === void 0) k22 = k2;
  o5[k22] = m2[k2];
}
...
function __asyncDelegator2(o5) {
  ...
  function verb(n3, f3) {
    i2[n3] = o5[n3] ? function(v3) {
      return (p2 = !p2) ? { value: __await2(o5[n3](v3)), done: n3 === "return" } : f3 ? f3(v3) : v3;
    } : f3;
  }
}
function __asyncValues2(o5) {
  if (!Symbol.asyncIterator) throw new TypeError("Symbol.asyncIterator is not defined.");
  var m2 = o5[Symbol.asyncIterator], i2;
  return m2 ? m2.call(o5) : (o5 = typeof __values2 === "function" ? __values2(o5) : o5[Symbol.iterator](), i2 = {}, verb("next"), verb("throw"), verb("return"), i2[Symbol.asyncIterator] = function() {
    return this;
  }, i2);
  function verb(n3) {
    i2[n3] = o5[n3] && function(v3) {
...
function yr(t) {
  ...
  const v3 = xe((y, f3) => {
    const { ex: b2, ey: E2, ez: B } = y, C2 = y.is0();
    f3 == null && (f3 = C2 ? wr : n3.inv(B));
    ...
    const { ex: E2, ey: B, ez: C2, et: A } = y, U = c3(E2 * E2), _ = c3(B * B), T2 = c3(C2 * C2), $ = c3(T2 * T2), R = c3(U * f3), V = c3(T2 * c3(R + _)), Y = c3($ + c3(b2 * c3(U * _)));
  ...
  class d3 {
    ...
    equals(f3) {
      S(f3);
      const { ex: b2, ey: E2, ez: B } = this, { ex: C2, ey: A, ez: U } = f3, _ = c3(b2 * U), T2 = c3(C2 * B), $ = c3(E2 * U), R = c3(A * B);
      return _ === T2 && $ === R;
    }
    is0() {
    ...
    double() {
      const { a: f3 } = e2, { ex: b2, ey: E2, ez: B } = this, C2 = c3(b2 * b2), A = c3(E2 * E2), U = c3(yt * c3(B * B)), _ = c3(f3 * C2), T2 = b2 + E2, $ = c3(c3(T2 * T2) - C2 - A), R = _ + A, V = R - U, Y = _ - A, Z = c3($ * V), X = c3(R * Y), et = c3($ * Y), pt = c3(V * R);
      return new d3(Z, X, pt, et);
    }
    add(f3) {
      S(f3);
      const { a: b2, d: E2 } = e2, { ex: B, ey: C2, ez: A, et: U } = this, { ex: _, ey: T2, ez: $, et: R } = f3;
      if (b2 === BigInt(-1)) {
        const re = c3((C2 - B) * (T2 + _)), oe = c3((C2 + B) * (T2 - _)), mt = c3(oe - re);
      ...
      const V = c3(B * _), Y = c3(C2 * T2), Z = c3(U * E2 * R), X = c3(A * $), et = c3((B + C2) * (_ + T2) - V - Y), pt = X - Z, ee = X + Z, ne = c3(Y - b2 * V), un = c3(et * pt), cn = c3(ee * ne), an = c3(et * ne), fn = c3(pt * ee);
  ...
  function O2(y) {
    ...
    const b2 = W("hashed private key", s2(y), 2 * f3), E2 = w3(b2.slice(0, f3)), B = b2.slice(f3, 2 * f3), C2 = I(E2), A = m2.multiply(C2), U = A.toRawBytes();
  ...
  function st(y, f3, b2 = {}) {
    ...
    const { prefix: E2, scalar: B, pointBytes: C2 } = O2(f3), A = tt(b2.context, E2, y), U = m2.multiply(A).toRawBytes(), _ = tt(b2.context, U, C2, y), T2 = z(A + _ * B);
  ...
  function Ct(y, f3, b2, E2 = at) {
    ...
    y = W("signature", y, 2 * A), f3 = W("message", f3), b2 = W("publicKey", b2, A), C2 !== void 0 && Tt("zip215", C2), o5 && (f3 = o5(f3));
    const U = Et(y.slice(A, 2 * A));
    let _, T2, $;
    try {
      _ = d3.fromHex(b2, C2), T2 = d3.fromHex(y.slice(0, A), C2), $ = m2.multiplyUnsafe(U);
    } catch {
      return false;
    }
...
var alphabetBytesToChars = alphabet.reduce((p2, c3, i2) => {
  p2[i2] = c3;
  return p2;
}, []);
var alphabetCharsToBytes = alphabet.reduce((p2, c3, i2) => {
  p2[c3.codePointAt(0)] = i2;
  return p2;
}, []);
function encode2(data) {
  return data.reduce((p2, c3) => {
...
*/
//# sourceMappingURL=chunk-JANVPZ2E.js.map
