...
var NumberUtil = {
  ...
  formatNumber(value, params) {
    ...
    return bigNumber.div(new big_default(10).pow(decimals)).round(round);
  },
  multiply(a, b) {
...
var ApiController = {
  ...
  async fetchWalletsByPage({ page }) {
    ...
    state7.wallets = CoreHelperUtil.uniqueBy([...state7.wallets, ...ApiController._filterOutExtensions(data)], "id").filter((w) => {
      var _a2;
      return (_a2 = w.chains) == null ? void 0 : _a2.some((chain) => chains.includes(chain));
    });
...
//# sourceMappingURL=chunk-BFMWJAQ4.js.map
