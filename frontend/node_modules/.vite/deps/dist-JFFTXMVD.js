...
// node_modules/@base-org/account/node_modules/eventemitter3/index.js
var require_eventemitter3 = __commonJS({
  "node_modules/@base-org/account/node_modules/eventemitter3/index.js"(exports, module) {
    "use strict";
...
function O(n2, u4, t3, i4, o3, r3, f4, e3, c3, s3) {
  ...
  n: if ("function" == typeof T3) try {
    if (m2 = u4.props, x2 = "prototype" in T3 && T3.prototype.render, C3 = (a3 = T3.contextType) && i4[a3.__c], M2 = a3 ? C3 ? C3.props.value : a3.__ : i4, t3.__c ? g2 = (h3 = u4.__c = t3.__c).__ = h3.__E : (x2 ? u4.__c = h3 = new T3(m2, M2) : (u4.__c = h3 = new k(m2, M2), h3.constructor = T3, h3.render = q), C3 && C3.sub(h3), h3.props = m2, h3.state || (h3.state = {}), h3.context = M2, h3.__n = i4, v3 = h3.__d = true, h3.__h = [], h3._sb = []), x2 && null == h3.__s && (h3.__s = h3.state), x2 && null != T3.getDerivedStateFromProps && (h3.__s == h3.state && (h3.__s = d({}, h3.__s)), d(h3.__s, T3.getDerivedStateFromProps(m2, h3.__s))), p3 = h3.props, w3 = h3.state, h3.__v = u4, v3) x2 && null == T3.getDerivedStateFromProps && null != h3.componentWillMount && h3.componentWillMount(), x2 && null != h3.componentDidMount && h3.__h.push(h3.componentDidMount);
    else {
    ...
    h3.state = h3.__s, null != h3.getChildContext && (i4 = d(d({}, i4), h3.getChildContext())), x2 && !v3 && null != h3.getSnapshotBeforeUpdate && (_2 = h3.getSnapshotBeforeUpdate(p3, w3)), S(n2, y(L2 = null != a3 && a3.type === b && null == a3.key ? a3.props.children : a3) ? L2 : [L2], u4, t3, i4, o3, r3, f4, e3, c3, s3), h3.base = u4.__e, u4.__u &= -161, h3.__h.length && f4.push(h3), g2 && (h3.__E = h3.__ = null);
  } catch (n3) {
...
function z(u4, t3, i4, o3, r3, f4, e3, c3, s3) {
  ...
  if (null === C3) b2 === k3 || c3 && u4.data === k3 || (u4.data = k3);
    ...
    else if (p3 && (u4.innerHTML = ""), S(u4, y(d3) ? d3 : [d3], t3, i4, o3, "foreignObject" === C3 ? "http://www.w3.org/1999/xhtml" : r3, f4, e3, f4 ? f4[0] : i4.__k && x(i4, 0), c3, s3), null != f4) for (a3 = f4.length; a3--; ) w(f4[a3]);
...
// node_modules/@base-org/account/node_modules/eventemitter3/index.mjs
...
function prependWithoutDuplicates(array, item) {
  const filtered = array.filter((i4) => i4 !== item);
...
async function findOwnerIndex({ address, client, publicKey, factory, factoryData }) {
  ...
  for (let i4 = Number(ownerCount) - 1; i4 >= 0; i4--) {
  ...
  try {
    ...
    if (success) {
      ...
      if (txReceipt == null ? void 0 : txReceipt.logs) {
        ...
        const usdcTransfers = [];
        for (let i4 = 0; i4 < txReceipt.logs.length; i4++) {
          const log = txReceipt.logs[i4];
...
//# sourceMappingURL=dist-JFFTXMVD.js.map
