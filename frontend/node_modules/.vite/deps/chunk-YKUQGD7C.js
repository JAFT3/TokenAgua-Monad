...
import {
  ...
  secp256k1,
  weierstrassPoints
} from "./chunk-MUGLOGFB.js";
import {
  createBase58check,
  pbkdf2,
  utils
} from "./chunk-COZMJE2P.js";
import {
  createClient,
...
function validate6(value) {
  return validate3(value) && size4(value) === 32;
}
...
function encodeString(value) {
  ...
  return {
    dynamic: true,
    encoded: concat4(padRight(fromNumber2(size4(hexValue), { size: 32 })), ...parts)
  };
}
...
var InvalidStorageKeySizeError = class extends BaseError3 {
  constructor({ storageKey }) {
    super(`Size for storage key "${storageKey}" is invalid. Expected 32 bytes. Got ${size4(storageKey)} bytes.`);
    Object.defineProperty(this, "name", {
      enumerable: true,
      configurable: true,
      writable: true,
...
function validate8(value) {
  return validate3(value) && size4(value) === 256;
}
...
function uid(length = 11) {
  if (!buffer || index + length > size5 * 2) {
    buffer = "";
    index = 0;
  ...
  const validateData = (struct, data) => {
    for (const param of struct) {
      ...
      if (bytesMatch) {
        ...
        if (size6 && size4(value2) !== Number.parseInt(size6))
          throw new BytesSizeMismatchError2({
            expectedSize: Number.parseInt(size6),
            givenSize: size4(value2)
          });
      }
...
function assert12(value) {
  ...
  const validateData = (struct, data) => {
    for (const param of struct) {
      ...
      if (bytesMatch) {
        const [, size6] = bytesMatch;
        if (size6 && size2(value2) !== Number.parseInt(size6, 10))
...
function hashType2(value) {
  const { primaryType, types: types2 } = value;
  const encodedHashType = fromString(encodeType3({ primaryType, types: types2 }));
...
*/
//# sourceMappingURL=chunk-YKUQGD7C.js.map
