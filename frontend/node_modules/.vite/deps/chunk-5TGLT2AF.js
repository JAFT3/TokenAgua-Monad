...
async function recoverPublicKey({ hash: hash2, signature }) {
  ...
  const { secp256k1: secp256k12 } = await import("./secp256k1-GKW3KEJM.js");
  const signature_ = (() => {
...
function decodeNumber(cursor, param) {
  ...
  const value = cursor.readBytes(32);
  return [
    size4 > 48 ? toBigInt(value, { signed }) : toNumber2(value, { signed }),
    32
  ];
}
...
function verify(options) {
  ...
  return secp256k1.verify(signature, from2(payload), toBytes2(publicKey), ...hash2 ? [{ prehash: true, lowS: true }] : []);
}
...
export {
  ...
  toRpcList,
  getCode,
  recoverPublicKey as recoverPublicKey2,
...
//# sourceMappingURL=chunk-5TGLT2AF.js.map
